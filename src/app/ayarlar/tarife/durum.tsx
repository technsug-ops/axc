/**
 * ============================================================================
 *  TARİFE DURUMU — YÜKLÜ PENCERELER + KAPSAM BOŞLUĞU (K230-③, 21.09.2026)
 * ----------------------------------------------------------------------------
 *  ⚠ BU GÖVDE TAŞINDI, YENİDEN YAZILMADI. Kullanıcı **iki kez** sordu:
 *  _"tarife penceresi ile komisyon yüklemenin farkı ne?"_ — ve ikinci kez
 *  sorulması, cevabın değil TASARIMIN sorunu olduğunu gösteriyordu. İki menü
 *  kalemi birleştirildi; bu blok artık tek kapının İÇİNDE yaşıyor.
 *
 *  ⛔ K49 KAPSAM BOŞLUĞU MANTIĞI OLDUĞU GİBİ KORUNDU — boşluğun bütün
 *  geçmişten hesaplanması, görüş sınırı beyanı, iptalli satışın sayılmaması.
 *  Taşırken özetlemek, neyin kaybolduğunu ölçülemez yapardı.
 * ============================================================================
 */
...
export async function TarifeDurumu() {
  /**
   * ⛔ İZİN BU GÖVDEDE DE SORULUR — çağıran ekranın sorduğuna
   * güvenilmez. Bu blok artık ayrı bir dosyada yaşıyor ve ikinci bir
   * ekran onu izin kapısı olmayan bir yere koyabilir; o gün korumanın
   * "çağıranın hatırlamasına" bağlı olması sessiz bir sızıntı olurdu.
   * (Anayasa: koruma disipline değil mekanizmaya bağlanır.)
   */
