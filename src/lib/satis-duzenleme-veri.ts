 ...
 * (`girdi.an = new Date()`, çağıran: app/satislar/[id]/duzenle-actions.ts). Sayım damgası da geçmişte
 ...
 * YAZIMLARI `girdi.an`. Duzenleme farki BUGUNE yazilir; gecmis hareket degistirilmez (ledger dokunulmazligi).
 *
