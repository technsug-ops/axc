 ...
 * (`girdi.an = new Date()`, çağıran: app/satislar/[id]/iptal-actions.ts). Sayım damgası da geçmişte
 ...
 * YAZIMLARI `girdi.an`. Iptal ayna hareketi iptalin YAPILDIGI ana yazilir, satisin tarihine degil.
 *
