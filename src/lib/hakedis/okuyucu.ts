 ...
 *
 *  Hücre çözücüleri (başlık normalleştirme, sayı ve tarih ayrıştırma)
 *  13.08.2026'da `@/lib/tablo/hucre`ye TAŞINDI: komisyon listesi okuyucusu
 *  da aynı toleransa ihtiyaç duyuyordu ve kopya yazılsaydı biri düzeltilip
 *  diğeri unutulurdu. Aşağıdaki yeniden dışa verme, bu modülden okuyan
 *  çağıranları (hakedis:dogrula) olduğu gibi bırakır.
 * ============================================================================
 */

export { basligiNormalle, basliklariDizinle, sayiCoz, tarihCoz };
