/** BETIK SINIFI: TEK_SEFERLIK — K152 ile giren satislara dosya maliyeti; parti `dosya-maliyet-20260903` kilidinde, dosya md5 dogrulamali. */
...
const BEKLENEN_MD5 = "78f408683638e8baaef63a91a69e9536"; // K152 aktarmasının izindeki dosya
const PARTI = "dosya-maliyet-20260903";
      ...
      await prisma.$transaction(async (tx) => {
        ...
        const parti = await tx.stockMovement.create({
          data: {
            ...
            note: PARTI + " · dosya beyanı (Guncel Satislar..xlsx · ÜRÜN ALIŞ FİYATI)",
          },
        });
