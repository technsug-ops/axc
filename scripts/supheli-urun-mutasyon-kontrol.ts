...
const MUTASYONLAR: Mutasyon[] = [
  ...
  { ad: "IZIN SORULMUYOR", yon: "FAZLADAN", dosya: EYLEM,
    bul: '  return !!b && b.izinler.has("urun.yaz");', koy: "  return !!b;", bozdugu: "urun yetkisi olmayan barkod yazar / urun pasife alir" },
