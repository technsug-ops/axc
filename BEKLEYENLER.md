...
| **K118** | **MALİYETİ DAMGALANMAMIŞ ÇIKIŞLAR — [AÇIK]** | Ölçüldü 31.08.2026: **6 çıkış hareketi, 19 adet** maliyet damgası olmadan defterden çıkmış (`COUNT_CORRECTION` ×2 · `ADJUSTMENT` ×4, 16–29.08 arası). Hiçbiri satışa bağlı değil, dolayısıyla **satış kârını bozmuyor** — ama o malların maliyeti hiçbir gidere yazılmadı. ⚠ **ÖNCE SORU, SONRA KOD:** sayım eksiği çıkan malın maliyeti nereye yazılmalı (gider mi, doğrudan zarar mı) — bu bir MUHASEBE kararı ve mimar+Halil’de. Karar gelmeden ekran/otomatik yazım açılmaz.
