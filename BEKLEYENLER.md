...
### ⏳ HALİL TESTİ BEKLİYOR — GERÇEK CİHAZDA KALDI

Yukarıdaki doğrulama betikle yapıldı, Halil testi hâlâ AÇIK (anayasa:
"sınanmamış ekran, ekran değildir" — betik kanıtı gerçek cihazda ekranı
görmenin yerine geçmez). **Test listesi:** ① Selliora'da sipariş
4529951386'yı aç (`/satislar` → ara) ② **"Kargo takip no"** alanı
**"62755155627683"** göstermeli ③ kargo firması bir yerde **"hepsiJET"**
görünmeli ④ bundan sonra rastgele başka bir HB siparişinde de aynısını
dene — birinde tesadüf olabilir, ikisi birden olmaz.
