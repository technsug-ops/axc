...
| H9 | **Arşivde İLERİ tarife var mı?** | ❓ **HALİL'E SORULACAK.** Salı/Cuma yayımlanan, tam dilimli (alt+üst limit) tarife dosyası arşivden indirilebiliyor mu? İndirilebilirse geçmiş dönemler için **dilim simülasyonu** kurulur; yalnız performans raporu veriyorsa geçmişte simülasyon yapılamaz ve kalem öyle kapanır. _Ayrım: rapor = "ne oldu" (denetim) · tarife = "ne olacak" (simülasyon)._ |
...
| K9 | **Dilim bilinçli GEÇMİŞ oran denetimi** | 🔨 **KAYNAK BELİRLENDİ 20.08.2026: "İndirimli Komisyon Tarifeleri" raporu.** Denetimin ihtiyacı olan üçü de var: barkod · pencere · **gerçekleşen** oran. Yayımlanan tarifeden daha iyi ölçüt — tarife niyeti, rapor sonucu söyler. ⛔ **ŞEMAYA GİRMEZ:** betik okuma anında okur, karşılaştırır, raporlar (74 satır kısmi veri `satisTarihiTarifesi`'yi bozardı; ayrıca bugün `0/39` satışımızı kapsıyor). **Bekliyor: ağustos–eylül dönemi raporu.** |
...
| 3 | API salt okuma | Örtüşme temiz · ⚡ **GEREKÇE DÖRDÜNCÜ KEZ, BU KEZ DIŞ KAYNAKTAN (20.08.2026): TY indirimli komisyon raporu temmuzda `56 ÜRÜNDE` satış yaptığımızı söylüyor; sistemde o dönemden neredeyse hiç satış yok. Elle girişin kapsam boşluğu artık kendi verimizle değil KANALIN verisiyle ölçülü.** · Önceki ölçüm `245 / 50 / 0` — 245 hakediş sipariş no, 50 satış kodu, **sıfır kesişim**. Biçimler BİREBİR uyumlu (HB 10 hane, TY 11 hane); sorun anahtar değil KAPSAM. Zincir tek yerden kopuyor: **elle giriş → kapsam boşluğu → hakediş kör → K-5 kapalı** |
