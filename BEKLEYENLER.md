...
| **K34a** | **Uyarısız okuma — bugün yapılabilir** | 📷 **BEKLEME YOK.** Barkodu okut, sistemin o barkod hakkında ne bildiğini göster. **UYARI YOK · ONAY KAPISI YOK · İSTİSNA KAYDI YOK · hiçbir şey engellenmez.** ⚠ Ayrı kalem olmasının sebebi: geçilecek kapı olmadığı için kullanıcı görmezden gelmeyi ÖĞRENEMEZ; uyarı katmanı (K34) defter kapandıktan sonra bunun üstüne oturur. ⭐ **ASIL DEĞERİ ÖLÇÜM:** bir hafta paketlerken kaç barkodun bulunamadığı sayılırsa **depo tarafından bağımsız bir kapsam ölçümü** çıkar — kanaldan da sistemden de bağımsız üçüncü kayıt (Aras'ın TY sayacını doğrulaması gibi). Elle giriş boşluğunun operasyon tarafındaki karşılığı. |
