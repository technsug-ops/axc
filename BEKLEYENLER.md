...
| **H25** | **İade süreci — kalan iki ölçüm** | ✅ **HB GELDİ** (23.08.2026): akış aynı, üç yapısal fark belgelendi (`docs/iade-sureci.md` §11). ⏳ **Kalan ①:** otomatik onay sayacı — 28 günlük ANALİZ saati çözüldü ve bir kayda tam oturdu, ama ikinci kayıt ~15 günlük **başka** bir sayaçta (28 günde başlangıç talepten ÖNCE düşüyor, imkânsız). Gereken: "Yanıtlanacak/Aksiyon Bekleyen" sekmesindeki bir iadenin detayı. ⏳ **Kalan ②:** N11 — iade tecrübesi yok, süresiz bekler. ⚠ İkisi de ŞEMAYI ETKİLEMİYOR (tarih hesaplanmıyor, kaydediliyor). |
