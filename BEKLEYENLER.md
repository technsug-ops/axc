...
| **K33** | **Kargo tazminatı bağı — kapanan iade "kayıp" görünüyor** | ⚠ **ÖLÇÜLDÜ, AÇILMADI.** İade müşteri kargoya verdikten sonra **10 gün** içinde bize ulaşmazsa (ör. kargoda kaybolursa) pazaryeri **sebebi ne olursa olsun onaylıyor** ve müşteriye parayı iade ediyor; satıcı **kargo şirketinden tazmin** talep ediyor. Bu bir KAYIP değil ALACAK. Bugün iade ile `Compensation` arasında bağ yok → kapanan iade sessizce kayıp görünüyor. Aynı bağ HB'nin "Hurda Geliri" yolu için de gerekiyor (K32). |
