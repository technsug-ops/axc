...
| **H22** | 🕓 **N11 kesinti kuralı TEK veri noktasından** | ⚠ **ÖLÇÜT DÜŞTÜ, SORU DURUYOR.** Halil'in verdiği `₺27,36` **gerçek bir N11 rakamı değil, örnek senaryoydu** (kendi beyanı 22.08.2026) — o yüzden kuralı değiştirmek için gerekçe sayılmaz. _Neredeyse değiştiriliyordu: aritmetik kusursuz tutuyordu (%1,258 × 2.175 = 27,3615) ve tutarlılık ikna edici görünüyordu. Melontik dersinin birebir tekrarı._ **ASIL SORU BİZDEN KAYNAKLI ve açık:** `PAZARLAMA_HIZMET = 12,58` **tek senaryodan** geldi (nesatilir, satış ₺1.000) ve kodun kendi notu diyor ki _"sabit mi ciro yüzdesi mi ayırt edilemedi; farklı bir fiyatla ikinci bir hesap gerekiyor."_ Bu belirsizlik **1.000 ₺ dışındaki HER fiyatta** N11 NET-2'sini kaydırıyor (2.175 ₺'de fark ~₺12). **Kapanış: gerçek bir N11 ekstresi ya da satıcı paneli çıktısı** — nesatilir'e ikinci senaryo girmek bunu ÇÖZMEZ, aynı kaynağın ikinci yolu olur. |
