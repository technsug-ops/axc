...
| H6 | **HB hizmet bedeli paket başına mı?** | 🕓 **ÖLÇÜLMEDEN TAŞINMAZ.** TY'nin ₺13,19'u paket başına olduğu ölçüldü (`11361665302`: 2 paket → −26,38). HB'nin ₺12,60'ı için aynı ölçüm YAPILMADI ve varsayım yapılmadı — kural `PER_SALE` olarak duruyor. Ölçüm yolu: HB hakediş/panelinde bölünmüş bir siparişin hizmet bedeli. |
