...
| **K27** | 🔴 **N11 kuralları DEFTERE geçmedi** | **AÇIK.** Ölçülen kural yalnız SİMÜLASYONDA; `ChannelFee` tablosunda N11'in **hiç kesinti kuralı yok**. Canlıda **2 gerçek N11 satışı** var ve kârları %2'lik kesinti hiç düşülmeden hesaplanmış — yani NET-2 olduğundan **iyimser**. Dosyanın kendi kuralı: _"bir kanalın ekstresi ölçüldüğünde kuralı deftere geçer."_ **Canlı veri yazımı, onay ister.** |
