...
| K9 | **Oran denetimi** — `canli:oran-denetimi` | ✅ **KURULDU + İLK KOŞUM 20.08.2026.** Salt okuma, `--uygula` bayrağı YOK. Dosya şemaya girmez, okuma anında karşılaştırılır. **İLK SONUÇ: eşleşen 7 kalem, oranı tutan 7, SAPMA 0.** ⚠ _"~₺18.000 eksik kâr"_ tahmini **ÇÜRÜDÜ** — indirimli oranlar zaten doğru girilmiş. Sınır gününe düşen 2 kalem için **hüküm verilmedi** (pencere `08:00→07:59`, `soldAt`ta saat yok → veriden çözülemez, bkz. **H20**). **Sırada:** geniş aralık (`01/07–20/08`) raporuyla yeniden koşum. |
