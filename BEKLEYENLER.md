...
| K9 | **Oran denetimi** — `canli:oran-denetimi` | ✅ **KURULDU + İKİ KOŞUM 20.08.2026.** Salt okuma, `--uygula` YOK. **GENİŞ ARALIK SONUCU (97 satır, `30.06–21.08`): eşleşen 7 kalem, tutan 7, SAPMA `0`.** ⚠ _"~₺18.000 eksik kâr"_ tahmini **ÇÜRÜDÜ** — kaydettiğimiz oranlar doğru. 🔴 **ASIL BULGU KAPSAM: rapor `227 adet` diyor, bizde `8`. Kaydı HİÇ olmayan 94 satır, ciro `₺751.583` (ALT SINIR — kısmi kayıtlı satır dahil değil).** Sınır gününe düşen 2 kalemde hüküm verilmedi (bkz. **H20**). |
