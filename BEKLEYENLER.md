...
| H5 | **`sfsfsf` test kaydı** | 🧹 **KARAR 20.08.2026: İPTAL, silme DEĞİL.** Silmek `SaleItem`i cascade siler ve stok hareketlerinin `saleItemId`si boşalır — stok düşük kalır, düşüren kaybolur. Ledger'a istisna açmak test kaydı için yapılmaz. İptal ise ciroya/NET'e/hakedişe girmez, stok doğru döner, geri alınabilir ve iz bırakır. **Halil ekrandan iptal edecek** (sebep: `MAGAZA_DIGER`, not: "test kaydı"). |
